        ...
        for i in self.items:
            ...
            for p in i.padres:
                if p.linea_base!=None:
                    if p.linea_base!=self and p.linea_base.estado=='Activa':
            ...
            for h in i.hijos:
                if h.linea_base!=None:
                    if h.linea_base!=self and h.linea_base.estado=='Activa':
            ...
            for a in i.antecesores:
                if a.linea_base!=None:
                    if a.linea_base!=self and a.linea_base.estado=='Activa':
            ...
            for s in i.sucesores:
                if s.linea_base!=None:
                    if s.linea_base!=self and s.linea_base.estado=='Activa':
